...
const blob1Ref = useRef<SVGPathElement>(null);
  ...
  return (
    ...
    <svg id="visual" className="blob-background" viewBox="0 0 900 600" width="900" height="600" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1">
    ...
    fill="#7132CA">
      ...
      fill="#BB004B" style={{visibility:"hidden"}}></path></g></svg>
